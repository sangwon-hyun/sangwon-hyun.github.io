...
Currently, my research centers around statistically analyzing the ocean's microbial ecology using high-resolution biological and remote sensing datasets (e.g., flow cytometry, metagenomics, DNA metabarcoding, and spatial proteomics). I often look at very small things -- like single-cell resolution flow cytometry data -- to answer very broad questions about ocean ecology. For novel datasets and technology, I build new tools and apply them to answer several questions:
...
*I'm looking for motivated students and postdocs to join my group!*
